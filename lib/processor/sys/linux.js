...
exports.mute = mute;
exports.wifi = util_1.cmdsRequired(["pkexec", "iw", "ip", "awk", "sh"], function wifi(opt) {
...
exports.ip = util_1.cmdsRequired(["ifconfig", "awk", "sh"], function ip() {
    return __awaiter(this, void 0, void 0, function* () {
...
function bc(opt) {
    return __awaiter(this, void 0, void 0, function* () {
        let ret = yield util_1.utils.exec("sh", [
            "-c", "echo 1+2 | bc"
        ]);
        return [{
                text: ret,
