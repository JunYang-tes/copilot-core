...
function parse(obj, fileName, name) {
    return __awaiter(this, void 0, void 0, function* () {
        const processors = {};
        let param = {
            cfg: config_1.getConfig(name(fileName, "").replace(/\.$/, "")),
            services: {}
        };
        if (obj.declare && util.isFunction(obj.declare)) {
            ...
            if (declare.services) {
                param.services = declare.services
                    ...
                    return {
                        key: serviceName,
                        value: services_1.getServices(serviceName, Object.assign({}, serviceParam, { namespace: name(fileName, "") }))
                    };
                })
...
function load({ dir = __dirname, name = (fileName, processorName) => `buildin.${fileName}.${processorName.replace("bound ", "")}` }) {
    return __awaiter(this, void 0, void 0, function* () {
