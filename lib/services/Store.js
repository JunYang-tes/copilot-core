...
const query = util_1.utils.promisify(db.each.bind(db));
...
class Store {
    ...
    get(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let ret = yield query(`select value from store where namespace = ? and key = ?`, this.namespace, key);
            if (ret) {
                return ret.value;
            }
            return null;
    ...
    getJson(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return JSON.stringify(yield this.get(key));
        });
    }
    setJson(key, json) {
        return __awaiter(this, void 0, void 0, function* () {
